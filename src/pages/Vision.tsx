...
const Vision = () => {
  ...
  const pillarsLeft = [
    { icon: Pill, title: "Dentistry", desc: "Global leader in implantology and laser dentistry." },
    { icon: Globe, title: "Entrepreneurship", desc: "Founder & CEO of multi-sector enterprises." },
    { icon: Bot, title: "AI Innovation", desc: "Building next-gen AI assistants and platforms." },
    { icon: Award, title: "Leadership", desc: "Military discipline shaping global ventures." },
    { icon: ShoppingCart, title: "Market", desc: "Curating premium marketplaces worldwide." },
  ];

  const pillarsRight = [
    { icon: Building2, title: "Real Estate", desc: "Designing eco-villages and smart cities." },
    { icon: GraduationCap, title: "Education", desc: "Mentoring future leaders and talents." },
    { icon: Podcast, title: "Podcasts", desc: "Sharing culture and history via media." },
    { icon: Sprout, title: "Philanthropy", desc: "Transforming communities with social projects." },
    { icon: Target, title: "Strategy", desc: "Architecting visions for societies and businesses." },
  ];
